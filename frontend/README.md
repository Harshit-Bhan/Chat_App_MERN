...
Arranges its children vertically (top to bottom).

spacing="5px" adds space between each child.

Think of it as a vertical div with automatic margin between children.

🔧 Use when: You want a list of items stacked on top of each other (like form fields).
